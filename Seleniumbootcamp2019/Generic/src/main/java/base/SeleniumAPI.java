...
public class SeleniumAPI {
        ...
        public static final String BROWSERSTACK_USERNAME = "mdullah1";
        public static final String BROWSERSTACK_AUTOMATE_KEY = "184UyTwqxQoNCEVx1VFF";
        ...
        public static WebDriver getCloudDriver(String browser, String browserVersion, String platform, String envName) throws MalformedURLException {
            ...
            capabilities.setCapability("os_version", "windows 10");
        ...
        public static void getScreenshot(WebDriver driver) {
            ...
            File file = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
            try {
                FileUtils.copyFile(file, new File("src\\test\\resources\\screenshots\\Screenshot\\amazon.png" + name + ".png"));
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
